...
const poolData = {
  ...
  cngn: {
    ...
    name: 'cNGN',
    ticker: 'cNGN',
    contractAddress: '0x52828daa48C1a9A06F37500882b42daf0bE04C3B',
    decimals: 18,
    region: 'NG',
    regionClass: 'region-ng',
    flagLargeClass: 'region-ng',
    platform: 'Aave V3',
    peg: 'NGN Pegged',
    regionFull: 'AFRICA',
    tvl: '$45,000,000',
    ...
    volatility: '0.15%',
    audit: 'VeriShield ✅',
    aiInsight: 'Nigeria first regulated stablecoin. SEC-approved with banking partnerships. High yield potential in emerging market.',
  },
  xidr: {
    id: 'xidr',
    name: 'XIDR',
