...
const portfolioData = [
  {
    ...
    regionFull: 'LATAM',
    positionValue: '$142,402.19',
    positionAmount: '712,010 BRZ',
    earnings: '+$1,058.40',
    apy: '8.92%',
  ...
  },
  {
    ...
    region: 'EU',
    name: 'Euro-E Vault',
    platform: 'Balancer V2',
    regionFull: 'EU Region',
    positionValue: '$82,510.21',
    positionAmount: '76,400 EUROE',
    earnings: '+$2,410.15',
    apy: '14.20%',
  ...
  },
  {
    ...
    platform: 'Aave + Uniswap',
    regionFull: 'Global',
    positionValue: '$60,000.00',
    positionAmount: '60,000 USDC',
    earnings: '+$633.57',
    apy: '6.50%',
